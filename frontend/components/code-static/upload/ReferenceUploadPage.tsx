...
import { parseReference } from '@/utils/code-static/excelParser';
import { saveReferences, getReferences, hasReferences } from '@/utils/code-static/db';
import type { Reference } from '@/types/code-static';
