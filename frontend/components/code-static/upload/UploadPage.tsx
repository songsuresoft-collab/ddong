...
import { parseProjectSummary } from '@/utils/code-static/excelParser';
import { saveSession, saveRulesetReports } from '@/utils/code-static/db';
import type { ParsedProjectReport, Session, RulesetReport } from '@/types/code-static';
...
const UploadPage: React.FC = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            router.push(`/sdv-solution/code-static/overview?session=${sessionId}`);
        } catch (err) {
