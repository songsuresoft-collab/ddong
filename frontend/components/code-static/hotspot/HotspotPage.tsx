...
import type { RulesetReport, FileSummary, DrawerState, Session } from '@/types/code-static';
            ...
            <div className="page-body">
                <div className="grid-2col">
                    ...
                    <div className="card">
                        ...
                        <div className="chart-container" style={{ height: 400 }}>
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={topByRemaining} layout="vertical" margin={{ left: 10, right: 40, top: 0, bottom: 0 }}>
                                    ...
                                    <YAxis
                                        ...
                                        tickFormatter={(v: string) => {
                                            ...
                                            return fileName.length > 22 ? fileName.substring(0, 20) + '…' : fileName;
                                        }}
                                    />
                                    <Tooltip
                                    ...
                                    />
                                    <Bar dataKey="remaining" radius={[0, 4, 4, 0]} barSize={16}
                                        cursor="pointer"
                    ...
                    <div className="card">
                        ...
                        <div className="chart-container" style={{ height: 400 }}>
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={topByRuleCount} layout="vertical" margin={{ left: 10, right: 40, top: 0, bottom: 0 }}>
                                    <XAxis type="number" hide domain={[0, 'dataMax + 10']} />
                                    <YAxis
                                        dataKey="file"
                                        type="category"
                                    ...
                                    <Tooltip
                                        ...
                                        labelStyle={{ color: '#e8eaf0' }}
                                    />
                                    <Bar dataKey="ruleCount" radius={[0, 4, 4, 0]} barSize={16}
                                        cursor="pointer"
